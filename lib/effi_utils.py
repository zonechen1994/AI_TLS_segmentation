...
def get_model_shape():
    if cfg.model == 'efficientnet-b0':
        block_idx = [2, 4, 10, 15]
        channels = [24, 40, 112, 320]
    elif cfg.model == 'efficientnet-b1':
        block_idx = [4, 7, 15, 22]
        channels = [24, 40, 112, 320]
    elif cfg.model == 'efficientnet-b2':
        block_idx = [4, 7, 15, 22]
        channels = [24, 48, 120, 352]
    elif cfg.model == 'efficientnet-b3':
        block_idx = [4, 7, 17, 25]
        channels = [32, 48, 136, 384]
    elif cfg.model == 'efficientnet-b4':
        block_idx = [5, 9, 21, 31]
        channels = [32, 56, 160, 448]
    elif cfg.model == 'efficientnet-b5':
        block_idx = [7, 12, 26, 38]
        channels = [40, 64, 176, 512]
    elif cfg.model == 'efficientnet-b6':
        block_idx = [8, 14, 30, 44]
        channels = [40, 72, 200, 576]
    elif cfg.model == 'efficientnet-b7':
